...
Elements.prototype.push = function(obj){
	obj.id = this.ctr++;
	this.es[obj.id] = obj;
};
Elements.prototype.put = function(obj){
	this.es[obj.id] = obj;
};
Elements.prototype.removeObject = function(obj){
	delete(this.es[obj.id]);
};
Elements.prototype.removeById = function(id){
	delete(this.es[id]);
};
//===============================================
//					CloudObject
